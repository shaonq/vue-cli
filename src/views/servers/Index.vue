...
<div style="overflow: auto;height:100%;">
    <div style="width:1200px;margin: 10px auto 80px;">
        <div class="u-flex">
            <div class="card u-flex__item">
                <div style="margin:20px">
                    <router-view></router-view>
                </div>
            </div>
            <div style="width:260px;padding-left:20px;">
                <div class="card" style="min-height:200px;padding:10px 0">
                    <router-link v-for="(item,index) in list" :key="index" class="link" :to="{path:item.to}" exact>{{item.name}}</router-link>
